...
Again, the fact that \(\hom_q(\mathcal{O}_X,-)\) appears in the closure of the \(q\)-mass embedding of the stability manifold is a reflection of a general theorem---the \(q\)-analogue of \Cref{thm:qhom} (see \cite[Corollary~4.13]{bap.deo.lic:20}).
