...
For example, the vertex \(v_0 = [ \cdots: 1+q : 1 : 0 : 1 : 1+q^{-1} : \cdots ]\) is the \(q\)-mass function of the lax pre-stability condition \(q^{-1} \cdot \tau\) where \(\tau\) is as in \Cref{prop:v0}.
